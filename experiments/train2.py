...
class ChessModel(torch.nn.Module):
  def __init__(self, input_dimension=1088, feature=256):
    super().__init__()
...
model = torch.load('chess2.model') if os.path.exists('chess2.model') else ChessModel()
